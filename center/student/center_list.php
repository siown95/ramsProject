                        ...
                        <div class="col-3">
                            <div class="card border-left-primary shadow text-center mt-2">
                                <div class="card-header">
                                    <img src="/center/img/<?= $val['center_eng_name'] ?>.png" class="img-thumbnail" alt="">
                                </div>
                                <div class="card-body">
                                    <a href="<?= "/" . $val['center_eng_name']  ?>/student/login.html" class="btn btn-outline-primary me-2">로그인</a>
                                    <a href="<?= "/" . $val['center_eng_name']  ?>/student/register.html" class="btn btn-outline-primary">회원가입</a>
                                </div>
                            </div>
                        </div>
                    <?php
