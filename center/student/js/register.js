$(document).ready(function () {
    ...
    $("#txtPassword").change(function() {
        if ($("#txtPassword").val() == $("#txtPasswordConfirm").val()) {
            $("#txtPassword").addClass("is-vaild");
            $("#txtPasswordConfirm").addClass("is-vaild");
        }
    });
    
    const passwordCheck = document.getElementById("txtPasswordConfirm");
    passwordCheck.addEventListener("focusout", function() {
        if ($("#txtPassword").val() == $("#txtPasswordConfirm").val()) {
            ...
            $("#txtPasswordConfirm").addClass("is-valid");
        } else {
            $("#txtPassword").removeClass("is-valid");
            $("#txtPasswordConfirm").removeClass("is-valid");
    ...
    $("#registerBtn").click(function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.success) {
                    alert(result.msg);
                    location.href = '/center/student/login2.html';
                    return false;
                } else {
                    alert(result.msg);
                    return false;
