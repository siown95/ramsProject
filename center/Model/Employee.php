...
class EmployeeInfo extends Model
{
    ...
    public function loadEmployee($state, $franchise_idx)
    {
        $sql = "SELECT 
                    e.user_no
                    , e.user_name
                ...
                LEFT OUTER JOIN codem c
                    ON c.code_num1 = '20' AND e.position = c.code_num2 AND c.code_num2 <> ''
                WHERE e.show_yn = 'Y'
                      AND e.state = '" . $state . "'
    ...
    public function msgInfoSelect($franchise_idx, $state)
    {
        $where_arr = array(
