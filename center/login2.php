...
$centerEngName = $infoClassCmp->getFranchiseeInfo2($user_id);
$centerIdx = $infoClassCmp->getFranchiseeInfo($centerEngName);

$idCheck = $permissionCls->idCheck($user_id, 'center');
...
if (!empty($idData['cnt'])) {
    ...
    $rs = $permissionCls->getPermission($user_id, $password, 'center', $centerIdx);
...
$result_arr['center_name'] .= $centerEngName;
