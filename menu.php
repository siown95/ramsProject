<ul id="menuList" class="nav nav-tabs">
    ...
    <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item menu">출근부확인</a></li>
    ...
    <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item menu">종합평가</a></li>
    ...
    <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
            <li><a class="dropdown-item menu">도서관리</a></li>
            <li><a class="dropdown-item menu" href="#bookrent">도서대출</a></li>
            <li><a class="dropdown-item menu">커리큘럼</a></li>
    ...
    <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
            <li><a class="dropdown-item menu" href="#inquiry_request">교육센터문의요청사항</a></li>
            <li><a class="dropdown-item menu" href="#board_list">자료실</a></li>
            <li><a class="dropdown-item menu">물품주문</a></li>
            <li><a class="dropdown-item menu menu1" href="#activity_error_report">활동지오류신고</a></li>
        </ul>
    </li>
    <li class="nav-item dropdown">
...
<script>
    ...
    $("#btnLeft").on("click", function() {
        link = link.replace('#', '');
        console.log("L => " + link);
        console.log("lm => " + lmenu);
        console.log("rm => " + rmenu);
