...
$idCheck = $permissionCls->idCheck($user_id, 'adm');
...
if (!empty($idData['cnt'])) {
    ...
    $rs = $permissionCls->getPermission($user_id, $password, 'adm');
    ...
    if (!empty($user_data)) {
        ...
        if ($user_data['state'] == '99') {
            ...
            $status = 'success';
            $_SESSION['logged_no_adm'] = $user_data['user_no'];
            $_SESSION['logged_id_adm'] = $user_data['user_id'];
            $_SESSION['logged_name_adm'] = $user_data['user_name'];
            $_SESSION['logged_phone_adm'] = phoneFormat($user_data['user_phone']);
            $_SESSION['logged_email_adm'] = $user_data['email'];
