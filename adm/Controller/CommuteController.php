...
include_once $_SERVER['DOCUMENT_ROOT'] . "/adm/Model/Commute.php";
...
class CommuteController extends Controller
{
    ...
    {
        try {
            $result = $this->commuteInfo->selectEmployee($user_no);
            return $result;
        } catch (Exception $e) {
    ...
    public function commuteSelect($params)
    {
        ...
        try {
            $result = $this->commuteInfo->commuteSelect($user_no, $now_date);
