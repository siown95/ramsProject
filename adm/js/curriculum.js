$(document).ready(function () {
    ...
    $("#btnSave").click(function () {
        ...
        var franchise_idx = $("#sel_center").val();
        ...
        $.ajax({
            url: '/adm/ajax/curriculumControll.ajax.php',
            dataType: 'JSON',
            type: 'POST',
    ...
    $("#sel_month, #sel_grade, #sel_center").on("change", function () {
        curriculum_load();
    });

    $("#curriculum_list").on("click", ".tc", function (e) {
        curriculum_select(e);
    });
            ...
            if (result.success) {
                $('#dataTable2').DataTable({
                    ...
                    createdRow: function (row, data) {
                        $(row).addClass('text-center align-middle booktc');
                        $("th").addClass('text-center align-middle booktc');
